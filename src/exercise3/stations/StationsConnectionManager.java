package exercise3.stations;

public class StationsConnectionManager {
	...
	public static void main(String[] args) {
		for(int i =0; i < inLineDistances.length; i++){
			for(int j = 0; j < inLineDistances.length; j++){
				System.out.print(inLineDistances[i][j]);
				System.out.print(" ");
			}
			System.out.println("");
		}
